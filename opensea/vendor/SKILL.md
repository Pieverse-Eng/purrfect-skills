---
name: opensea-vendor
description: OpenSea API read operations — CLI, scripts, and references for querying collections, NFTs, listings, offers, events, tokens, and swaps. This is the vendor data layer. For write operations (buy, sell, create offer, create listing), always read the parent opensea skill first — it contains the complete workflow and routing rules.
