...
Use the Glob tool to find `vendor/common/discover-pools.mjs` and note its absolute path. Then run:

```bash
PCS_DISCOVER_POOLS_SCRIPT=/absolute/path/to/vendor/common/discover-pools.mjs
CHAIN="bsc" TOKEN0="0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82" TOKEN1="0x55d398326f99059fF775485246999027B3197955" ORDER_BY="tvlUSD" \
  node "$PCS_DISCOVER_POOLS_SCRIPT"
```
