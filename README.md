...
| `pieverse-redpacket` | Pieverse OKX red packet claim flow — creates an OKX A2A payment request and submits only the paymentId to Pieverse backend for validated funder payout. |
