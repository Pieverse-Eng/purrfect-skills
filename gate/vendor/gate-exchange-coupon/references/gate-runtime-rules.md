---
name: gate-exchange-coupon-runtime-rules
version: "2026.4.3-1"
updated: "2026-04-03"
description: "Packaged runtime rules for gate-exchange-coupon so the published skill bundle contains every mandatory guardrail referenced by SKILL.md."
---

# Gate Coupon Runtime Rules

> Packaged runtime rules for `gate-exchange-coupon`.
...
- This skill is read-only. Do not attempt trading, transfers, or other write actions through this skill.

## 3. Failure Handling

- On missing `gate-cli` configuration, auth failure, or unsupported coupon filters, explain why the requested query cannot proceed.
