...
Select tools that answer the question, not every row. See the
[parameter guide](tool-parameters.md) for Tavily extraction limits and Finnhub
field semantics; follow the main skill's access rules.
